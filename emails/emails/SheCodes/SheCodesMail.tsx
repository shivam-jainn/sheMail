  ...
  return (
    ...
    >
        ...
        <Body className="bg-white">
          <div className="bg-[#7046E7] opacity-[70%] mx-auto absolute top-0 rounded-[50%] w-[100%] h-[100px] blur-[100px] z-[-1]"></div>
          <div className=" px-[5%] md:px-[15%] ">
            ...
            <div className="flex ">
              ...
              />
              <Text className="text-base md:text-lg my-auto">
            ...
            <Section className=" mx-auto my-[8%] md:my-[2%]">
              <Row className="">
                ...
                <Column className="p-[5px] md:p-0"></Column>
           ...
           <Section className=" my-[8%] md:my-[2%]">
           <Row  >
              <Column className="rounded-[16px] bg-[#A363E4]   px-[10px] ">
                <div className="text-base md:text-2xl text-center text-white">
                  {" "}
                  1<sup>st</sup> <br/>Prize <br />₹1,00,000
                </div>
              </Column>
              <Column className="p-[5px] md:p-0"> </Column>
              <Column className=" 	 rounded-[16px] bg-[#A363E4] px-[10px] ">
